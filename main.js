        ...
        if (editId) {
            try {
                let value = await axios
                    .put(`https://crudcrud.com/api/7bfda3bd452d49b6a3360a848ff0fe1a/ProductData/${editId} `, obj)
                    console.log(value);
            ...
            try {
                let res = await axios
                    .post(`https://crudcrud.com/api/7bfda3bd452d49b6a3360a848ff0fe1a/ProductData`, obj)
...
async function showOrderOnUI(ID) {
    try {
        ...
        let res = await axios
            .get(`https://crudcrud.com/api/7bfda3bd452d49b6a3360a848ff0fe1a/ProductData/${ID}`)
...
async function deleteOrder(ID) {
    try {
        ...
        removeOrderFromUI(ID)
        let res = await axios
            .delete(`https://crudcrud.com/api/7bfda3bd452d49b6a3360a848ff0fe1a/ProductData/${ID}`)
            console.log(res);
    }
    catch (error) {
        console.log(error);
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
       let res = await axios
            .get(`https://crudcrud.com/api/7bfda3bd452d49b6a3360a848ff0fe1a/ProductData`)       
            // console.log(res);
